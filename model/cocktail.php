...
class Cocktail
{
    ...
    public $Image_Cocktail;

    public function __construct(int $Cocktail_ID, $Nom_Cocktail, $Description_Cocktail, $Est_Disponible, $Nombre_Ingredient, $Image_Cocktail) {
        ...
        $this->Image_Cocktail=$Image_Cocktail;
    }
}
