...
require_once('/var/www/html/CocktailMachine/model/gateway/gatewayUtilisateur.php');
...
<body onload="loadThemCSSFile(getStorage())">
    ...
    <form action="" method="post">
        ...
        <div class="row">
            ...
            <input type="password" class="input" placeholder="Retaper le même mot de passe" name="VerifPassword" required>
        </div>
